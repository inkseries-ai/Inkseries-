...
export default function MaintenancePage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      {/* Background gradient */}
      <div className="fixed inset-0 bg-gradient-to-br from-amber-950/20 via-zinc-950 to-zinc-950" />
      ...
      <div className="relative z-10 max-w-md w-full text-center space-y-8">
        ...
        <div className="relative mx-auto w-24 h-24">
          ...
          <div className="relative w-full h-full bg-zinc-900 rounded-full flex items-center justify-center border border-amber-500/30">
        ...
        <div className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">
            {info?.message || "We're making some improvements to bring you a better reading experience."}
          </p>
        </div>
        
        {/* Status */}
        <div className="bg-zinc-900/60 backdrop-blur border border-zinc-800 rounded-xl p-6 space-y-4">
          <div className="flex items-center justify-center gap-2 text-amber-500">
            <Clock className="w-5 h-5 animate-pulse" />
            <span className="font-medium">Maintenance in Progress</span>
          </div>
          <p className="text-sm text-zinc-500">
            Our team is working to make Inkseries even better. Thanks for your patience!
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-4">
          <a 
            ...
            className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-amber-500 hover:border-amber-500/50 transition-colors"
          >
